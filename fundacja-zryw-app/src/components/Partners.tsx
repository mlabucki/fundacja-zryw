...
const Partners: React.FC = () => {
  return (
    <>
      <Container>
        <h2 className="font-new-order text-green text-[54px] tracking-[-0.03em] mt-20">
          Zaufali <br className="xs:hidden" /> nam
        </h2>
      </Container>
      <section className="h-[128px] xs:h-[190px] mt-9 overflow-hidden xs:mt-25 flex mx-auto">
        <div className="inline-flex gap-x-6 justify-center logos-slide px-3">
          {partners.map(({ img }, i) => (
            <div
              key={img + `${i} 1`}
              className="w-[133px] xs:w-[199px] h-[128px] xs:h-[190px] bg-beige border-1 border-beige-b flex justify-center items-center rounded-lg p-3"
            >
      ...
      <Container>
        <div className="flex mt-6 xs:mt-3">
          <p className="ml-auto text-xs xs:text-base font-calluna">
            Zostań partnerem
          </p>
        </div>
      </Container>
